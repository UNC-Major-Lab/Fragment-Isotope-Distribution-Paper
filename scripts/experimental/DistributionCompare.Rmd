...
```{r dataManipulation, echo=FALSE, fig.width=6, fig.height=4, echo=FALSE, message=FALSE, warning=FALSE, dev='svg'}
#load libraries
library(ggplot2)
library(reshape2)
library(plyr)
...
#load data from file
distData <- read.table("distributionScores.out", header=T, sep="\t")
