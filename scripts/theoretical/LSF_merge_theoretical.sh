...
python ${SOURCE_DIR}/scripts/theoretical/mergeTheoreticalComparisons.py $IN_DIR BIN_SIZE_CHISQUARE "scores_precursor_" $LSB_JOBINDEX 10 > ${IN_DIR}"/merged_precursor_scores_"${LSB_JOBINDEX}".out"
