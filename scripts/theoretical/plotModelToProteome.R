...
print(
  ...
  # sulfur-specific splines
  + geom_line(data=data.spline, aes(x=precursor.mass, y=probability, group=S), color="black", linetype="dashed")
  # average spline
  + geom_line(data=data.spline.avg, aes(x=precursor.mass, y=probability), color="black")
  # averagine model
  + geom_line(data=data.averagine, aes(x=precursor.mass, y=probability), color="blue")
  )
